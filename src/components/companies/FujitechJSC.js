...
class FujitechJSC extends Component {
    render() {
        return (
            <div className="w3-container">
                <h5 className="w3-opacity"><strong>Fujitech JSC</strong></h5>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li><b><em>Technical:</em></b> Linux/CentOS, TypeScript, JavaScript, HTML5, CSS3, Angular, Git, Bootstrap 4, AWS Service (EC2, S3), MySQL, Restful API</li>
                            <li><b><em>Tools - Utilities:</em></b> Backlog, ChatWork, Skype, Google Drive, Email, Visual Code, Slack</li>
                            <li><b><em>Project Phases:</em></b> Requirement definition, Programming, Unit test, Integrated test, Maintenance and Operation</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>Website buying book online: https://motsachmogu.vn</li>
                    <li>Website introducing game shinchan: http://shinchan.vn</li>
                    <li>Website introducing company: https://zodiaq.tokyo</li>
